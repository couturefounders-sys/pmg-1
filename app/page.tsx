    ...
    <main className="relative w-full min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-10 bg-white" style={{ paddingTop: 'clamp(48px, 5vw, 96px)', paddingBottom: 'clamp(48px, 5vw, 96px)' }}>
        ...
        <div className="flex justify-center items-center px-4 flex-wrap" style={{ maxWidth: 'min(1400px, 95%)', margin: '0 auto', gap: 'clamp(8px, 0.5vw, 0px)' }}>
          <div className="flex flex-col items-center" style={{ width: 'clamp(150px, 16vw, 260px)' }}>
            ...
            <p className="font-poppins font-semibold" style={{ fontSize: 'clamp(18px, 1.94vw, 32px)', lineHeight: '1.2', color: '#14358A', marginBottom: 'clamp(4px, 0.56vw, 10px)' }}>9x</p>
            <p className="font-poppins font-normal text-center" style={{ fontSize: 'clamp(13px, 1.25vw, 20px)', lineHeight: '1.5', color: '#000' }}>Average Client ROI</p>
          </div>
          ...
          <div className="flex flex-col items-center" style={{ width: 'clamp(150px, 16vw, 260px)' }}>
            ...
            <p className="font-poppins font-semibold" style={{ fontSize: 'clamp(18px, 1.94vw, 32px)', lineHeight: '1.2', color: '#14358A', marginBottom: 'clamp(4px, 0.56vw, 10px)' }}>72%</p>
            <p className="font-poppins font-normal text-center" style={{ fontSize: 'clamp(13px, 1.25vw, 20px)', lineHeight: '1.5', color: '#000' }}>On-Time Resolution</p>
          </div>
          <div className="flex items-center justify-center" style={{ width: 'clamp(60px, 7vw, 120px)', alignSelf: 'flex-start', marginTop: 'clamp(10px, 2.08vw, 40px)' }}><Image src="/stat-arrow.png" alt="" width={140} height={40} style={{ width: 'auto', height: 'auto', maxWidth: '100%' }} /></div>
          <div className="flex flex-col items-center" style={{ width: 'clamp(150px, 16vw, 260px)' }}>
            ...
            <p className="font-poppins font-semibold" style={{ fontSize: 'clamp(18px, 1.94vw, 32px)', lineHeight: '1.2', color: '#14358A', marginBottom: 'clamp(4px, 0.56vw, 10px)' }}>32%</p>
      ...
      <div className="relative z-10 bg-white" style={{ paddingTop: 'clamp(40px, 4.5vw, 80px)', paddingBottom: 'clamp(40px, 4.5vw, 80px)' }}>
        ...
        <div className="flex items-center justify-center flex-wrap" style={{ gap: 'clamp(12px, 1.39vw, 20px)' }}>
          ...
          <button className="font-poppins font-semibold hover:bg-blue-50 transition-colors" style={{ background: 'transparent', border: '2px solid #14358A', borderRadius: '82px', padding: 'clamp(12px, 1.39vw, 22px) clamp(24px, 3.47vw, 54px)', fontSize: 'clamp(14px, 1.25vw, 20px)', color: '#14358A' }}>Understand Our Approach</button>
        </div>
      </div>
      ...
      <div className="relative z-10 bg-white" style={{ paddingTop: 'clamp(40px, 4.5vw, 80px)', paddingBottom: 'clamp(40px, 4.5vw, 80px)' }}>
        <h2 className="text-center font-dm-sans font-bold" style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 'clamp(28px, 3.33vw, 56px)', lineHeight: '105%', letterSpacing: '-0.03em', color: '#14358A', marginBottom: 'clamp(16px, 1.5vw, 32px)' }}>Operative Across 4 Continents</h2>
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-8 px-4" style={{ maxWidth: 'min(900px, 90%)', margin: 'clamp(24px, 2.5vw, 40px) auto 0' }}>
          {['Aspen CO', 'Phoenix AZ', 'Chicago IL', 'Victoria BC', 'Montreal QC', 'Hong Kong', 'Bucharest', 'Manila', 'Niagara Falls ON', 'Gqeberha SA', 'San Diego CA', 'Johannesburg SA'].map(city => (
            <span key={city} className="font-dm-sans font-medium" style={{ fontSize: 'clamp(12px, 1.04vw, 16px)', color: '#14358A', border: '1px solid #14358A', borderRadius: '20px', padding: 'clamp(4px, 0.42vw, 6px) clamp(12px, 1.25vw, 18px)' }}>{city}</span>
          ))}
        </div>
      </div>
