      ...
      <div className="relative z-10 bg-white" style={{ paddingTop: 'clamp(48px, 5vw, 96px)', paddingBottom: 'clamp(48px, 5vw, 96px)' }}>
        ...
        <div className="flex justify-center items-center px-4 flex-wrap" style={{ maxWidth: 'min(1400px, 95%)', margin: '0 auto', gap: 'clamp(8px, 0.5vw, 0px)' }}>
          <div className="flex flex-col items-center" style={{ width: 'clamp(150px, 16vw, 260px)' }}>
            ...
            <p className="font-poppins font-bold" style={{ fontSize: 'clamp(24px, 2.75vw, 39.6px)', lineHeight: '44px', color: '#14358A', marginBottom: 'clamp(4px, 0.56vw, 10px)' }}><AnimatedCounter end={9} suffix="x" /></p>
          ...
          <div className="flex flex-col items-center" style={{ width: 'clamp(150px, 16vw, 260px)' }}>
            ...
            <p className="font-poppins font-bold" style={{ fontSize: 'clamp(24px, 2.75vw, 39.6px)', lineHeight: '44px', color: '#14358A', marginBottom: 'clamp(4px, 0.56vw, 10px)' }}><AnimatedCounter end={72} suffix="%" /></p>
          ...
          <div className="flex flex-col items-center" style={{ width: 'clamp(150px, 16vw, 260px)' }}>
            ...
            <p className="font-poppins font-bold" style={{ fontSize: 'clamp(24px, 2.75vw, 39.6px)', lineHeight: '44px', color: '#14358A', marginBottom: 'clamp(4px, 0.56vw, 10px)' }}><AnimatedCounter end={32} suffix="%" /></p>
          ...
          <div className="flex flex-col items-center" style={{ width: 'clamp(150px, 16vw, 260px)' }}>
            ...
            <p className="font-poppins font-bold" style={{ fontSize: 'clamp(24px, 2.75vw, 39.6px)', lineHeight: '44px', color: '#14358A', marginBottom: 'clamp(4px, 0.56vw, 10px)' }}><AnimatedCounter end={84} suffix="%" /></p>
      ...
      <div className="relative z-10 bg-white" style={{ paddingTop: 'clamp(40px, 4.5vw, 80px)', paddingBottom: 'clamp(40px, 4.5vw, 80px)' }}>
        ...
        <div className="flex justify-center items-center flex-wrap" style={{ gap: 'clamp(16px, 1.67vw, 32px)', marginBottom: 'clamp(32px, 3.5vw, 64px)' }}>
          ...
          <div className="flex flex-col items-center justify-center" style={{ border: '1px solid #14358A', borderRadius: '40px', padding: 'clamp(12px, 1.39vw, 22px) clamp(24px, 3.47vw, 54px)' }}>
            <p className="font-dm-sans font-bold" style={{ fontSize: 'clamp(24px, 2.75vw, 39.6px)', lineHeight: '44px', color: '#14358A', opacity: 0.9 }}><AnimatedCounter end={65} suffix="+" /></p>
