      ...
      <FadeInSection delay={0} direction="up" animateOnInitialView>
        ...
        >
          <div className="text-center mx-auto" style={{ maxWidth: 'min(760px, 90%)' }}>
            ...
            >
              Career Catalyst Mentorship Application
            </h1>
            <p
            ...
            >
              Thank you for your interest in the PMG Career Catalyst Mentorship Program. Please complete the application below to join our next cohort.
            </p>
          </div>
        </div>
      </FadeInSection>
        ...
        >
          <FadeInSection direction="up">
            ...
            >
              ...
              >
                Application form coming soon. In the meantime, please contact us directly at careers@pmgconsulting.com to express your interest in the PMG Career Catalyst Mentorship Program.
              </p>
              ...
              >
                The program is designed for recent post-secondary graduates looking to jumpstart their careers in Operations, Customer Experience, People and Organizations, and Marketing. We can't wait to meet you!
              </p>
